...
ocr_interactions = ocr_interactions[ocr_interactions$celltype %in% c("hMSC_Adipocytes",  "hMSC_osteoblasts")==F,]


pdf("plots/promoter_ocr_distances_remove_hMSC.pdf", useDingbats=FALSE)
