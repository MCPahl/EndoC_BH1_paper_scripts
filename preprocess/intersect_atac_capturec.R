...
#save rdata
save(intersection_by_celltype, file = "intersections/capture_c_atac_seq_celltypes_22XY.RData")
...
lapply(intersection_by_celltype, function(intersection_dat){
	...
	write.table(intersection_dat, file = paste0("intersections/", unique(intersection_dat$celltype), "_captureC_atac_seq_intersection_22XY.txt"), quote=FALSE, row.names=F, sep="\t")
})
